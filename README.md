...
# 1st_survey - сбор данных весной 2023
...
# 2nd_survey - сбор данных зимой 2024
...
Определеям с помощью графика каменистой осыпи и симмуляционного анализа оптимальное количество факторов: 1 или 3-4
...
Берём 4 из-за теории и проверяем -> нагрузки не совпали с ожиданиями, модель не посчиталась
...
Определяем кол-во факторов (3, так как на 4 фактор нет нагрузок)
...
Модель с тремя факторами предпочтительнее, но всё равно кривая
